...
router.post("/response", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const key = req.query.key;
    const dump = yield redisCollector.getDump(key);
    const mock = req.body;
    if (dump != null) {
        yield redisCollector.createMockResoponse(dump, mock);
    }
    else {
